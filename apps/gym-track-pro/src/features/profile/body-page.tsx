...
import { BMI_LABELS, BMI_SCALE_COLOR } from './bmi-utils'
import { BmiSilhouette } from './bmi-silhouette'
import { WeightChart } from './weight-chart'
import { useBodyPage } from './use-body-page'
    ...
    <div className='flex flex-col gap-3.5 pb-10'>
      ...
      {bmi && (
        <div className='flex gap-3'>
          <div className='flex min-w-30 flex-col items-center gap-2 rounded-[16px] border border-[#1e1e1e] bg-card-dark p-3'>
            <p className='text-muted text-[11px]'>Silueta estimada</p>
            <BmiSilhouette category={category} gender={gender} size={150} />
            <p
