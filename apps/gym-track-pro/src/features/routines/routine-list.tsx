      ...
      <div className='flex-1 space-y-3 overflow-y-auto px-5 py-4 pb-20'>
        {isLoading ? (
          ...
          <div className='flex flex-col items-center justify-center py-12 text-center'>
            <p className='mb-4 text-sm text-muted'>No tienes rutinas creadas</p>
            <button
              onClick={onCreateNew}
          ...
          routines.map((routine) => (
            <div
              ...
              className='hover:bg-card-dark cursor-pointer rounded-lg border border-border bg-card p-4 transition-colors hover:border-primary'
            >
                  ...
                  {confirmId === routine.id ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className='bg-card-dark rounded-md px-2 py-1 text-xs text-muted'
                      >
                        Cancelar
                      </button>
                    </div>
              ...
              {routine.description && (
                <p className='mb-2 text-xs text-muted'>{routine.description}</p>
              )}
